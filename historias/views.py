...
def ajax_add_historia(request):
    ...
    new_consulta.abdomen_region_inginal = data['consulta']['abdomen_region_inginal']
    ...
    new_consulta.genitourinario_testiculo = data['consulta']['genitourinario_testiculo']
    new_consulta.genitourinario_glande = data['consulta']['genitourinario_glande']
